...
# Codex skill: employment-legal-hiring-review

1. Load `~/.codex/claude-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint, hiring review triggers, restrictive covenant policy.
...
`~/.codex/claude-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint, hiring review triggers, restrictive
covenant policy, offer letter template location.

## Output header

Prepend the work-product header from `~/.codex/claude-for-legal/employment-legal/CLAUDE.md` → `## Outputs` (it differs by user role — see `## Who's using this`).
...
Check the jurisdiction table in `~/.codex/claude-for-legal/employment-legal/CLAUDE.md` for this state/country. If it's
...
Per `~/.codex/claude-for-legal/employment-legal/CLAUDE.md` restrictive covenant policy: does this hire even get one?
...
Check the `~/.codex/claude-for-legal/employment-legal/CLAUDE.md` table for this jurisdiction. Common categories to
...
**Before producing a "Clear to send" recommendation or a final offer letter for signature:** Read `## Who's using this` in `~/.codex/claude-for-legal/employment-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
