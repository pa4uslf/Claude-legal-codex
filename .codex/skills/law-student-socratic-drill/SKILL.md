...
description: >
  Codex CLI version of law-student:socratic-drill. Socratic drilling — it asks, you answer, it pushes back. Does NOT give you the answer until you've earned it. Use when the user says "drill me on", "quiz me", "socratic", "test me on [subject]", or wants to study actively.
argument-hint: "[subject or topic]"
---

# Codex Adaptation Notes

This skill was converted from `law-student:socratic-drill` in the Claude for Legal repository. In Codex CLI, invoke it by asking for the workflow by name, for example `law-student-socratic-drill`, or by describing the legal task in natural language.
...
# Codex skill: law-student-socratic-drill

1. Load `~/.codex/claude-for-legal/law-student/CLAUDE.md` → learning style, classes, weak areas.
...
`~/.codex/claude-for-legal/law-student/CLAUDE.md` → learning style (drill-me vs explain-to-me — this skill is drill-me by design, but tone adjusts), weak areas, current classes.

## The drill

### Step 1: Pick the topic

User names it, or pull from weak areas in `~/.codex/claude-for-legal/law-student/CLAUDE.md`. If they keep avoiding a subject, that's the one to drill.
...
1. The student has actually uploaded materials (notes, outlines, case briefs, flashcards) referenced in `~/.codex/claude-for-legal/law-student/CLAUDE.md` → Seed materials, and
