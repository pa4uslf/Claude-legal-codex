...
# Codex skill: privacy-legal-reg-gap-analysis

1. Load `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md` → privacy policy commitments, regulatory footprint, DSAR systems.
...
This skill diffs the new requirement against what you currently do (per `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md` → Privacy policy commitments + the practices documented in PIAs) and produces a gap list with a remediation plan.
