...
# Codex skill: litigation-legal-demand-intake

1. Load `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` → demand-letter practice, landscape, risk calibration.
...
5. Write `~/.codex/claude-for-legal/litigation-legal/demand-letters/[slug]/intake.md`.
...
- Desired outcome dollar value ≥ the medium-severity band from `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` risk calibration
- Counterparty is a customer, competitor, or frequent adversary per `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` landscape
- User ran with `--full`
...
`[type]-[counterparty-short]-[yyyy-mm]`. Confirm uniqueness in `~/.codex/claude-for-legal/litigation-legal/demand-letters/`.

### `~/.codex/claude-for-legal/litigation-legal/demand-letters/[slug]/intake.md`
...
- Run the conflicts check. If the counterparty is a customer or known entity, flag that this should clear conflicts (per `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md`) before sending — but the check itself lives in the matter-intake workflow or outside this skill.
