...
# Codex skill: legal-clinic-semester-handoff

1. Load `~/.codex/claude-for-legal/legal-clinic/CLAUDE.md` → clinic profile, semester dates, supervision style.
2. Load `~/.codex/claude-for-legal/legal-clinic/deadlines.yaml` and `~/.codex/claude-for-legal/legal-clinic/client-comms/[case-id]/log.md` per case.
...
5. Generate per-case handoff memo → `~/.codex/claude-for-legal/legal-clinic/handoffs/[semester]/[case_id].md`.
6. Generate cohort summary → `~/.codex/claude-for-legal/legal-clinic/handoffs/[semester]/_summary.md`.
...
- `~/.codex/claude-for-legal/legal-clinic/CLAUDE.md` → clinic profile, semester, practice areas, supervision style
- `~/.codex/claude-for-legal/legal-clinic/deadlines.yaml` → all active deadlines, grouped by case
- `~/.codex/claude-for-legal/legal-clinic/client-comms/[case-id]/log.md` (per case) → communications history
...
- Pull all active cases (from intake records + `~/.codex/claude-for-legal/legal-clinic/deadlines.yaml` case_ids + client-comms folders)
...
*Pulled from `~/.codex/claude-for-legal/legal-clinic/deadlines.yaml`. Incoming student's first job is to confirm these are accurate and owned.*
...
*From `~/.codex/claude-for-legal/legal-clinic/client-comms/[case-id]/log.md`. Three-line summary here; incoming student reads the full log.*
...
After all per-case memos, produce `~/.codex/claude-for-legal/legal-clinic/handoffs/[semester]/_summary.md`:
...
Once reviewed, handoff memos live at `~/.codex/claude-for-legal/legal-clinic/handoffs/[semester]/[case_id].md`. The incoming student reads them during their `/ramp` run at the start of next semester — `/ramp` should surface the memos for cases the new student is assigned.

## Integration

- **`/ramp`:** at the start of next semester, reads `~/.codex/claude-for-legal/legal-clinic/handoffs/[most-recent-semester]/` and surfaces per-case memos for the cases each new student is taking on.
