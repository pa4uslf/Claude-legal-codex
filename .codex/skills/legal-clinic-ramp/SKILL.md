...
# Codex skill: legal-clinic-ramp

1. Check `~/.codex/claude-for-legal/legal-clinic/CLAUDE.md` is set up. If placeholders: "Ask [professor] to run `legal-clinic-cold-start-interview` first."
...
`~/.codex/claude-for-legal/legal-clinic/CLAUDE.md` → clinic profile, practice areas, jurisdiction, handbook path, supervision style, practice-area templates.
...
Read from `~/.codex/claude-for-legal/legal-clinic/CLAUDE.md` and the ingested handbook. Cover, interactively:
