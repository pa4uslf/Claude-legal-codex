...
description: >
  Codex CLI version of litigation-legal:matter-intake. Intake a new matter — uniform questions covering identification, conflicts, source, risk triage, materiality, outside counsel, owners, legal hold, and key dates; writes matter.md and history.md and appends a structured row to _log.yaml. Use when the user says "new matter", "intake this matter", or wants to bring a new matter into the portfolio.
argument-hint: "[optional matter name]"
---

# Codex Adaptation Notes

This skill was converted from `litigation-legal:matter-intake` in the Claude for Legal repository. In Codex CLI, invoke it by asking for the workflow by name, for example `litigation-legal-matter-intake`, or by describing the legal task in natural language.
...
# Codex skill: litigation-legal-matter-intake

1. Load `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` → risk calibration (for triage), landscape (for context, conflicts method), stakeholders (for who to loop in).
...
5. Create `~/.codex/claude-for-legal/litigation-legal/matters/[slug]/matter.md` — full narrative intake.
6. Create `~/.codex/claude-for-legal/litigation-legal/matters/[slug]/history.md` — seeded with the intake as the first entry.
7. Append structured row to `~/.codex/claude-for-legal/litigation-legal/matters/_log.yaml`.
...
- `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` — risk calibration (triage thresholds, materiality, settlement ladder), landscape (stakeholders, outside counsel bench).
- `~/.codex/claude-for-legal/litigation-legal/matters/_log.yaml` — to confirm slug uniqueness.
...
Before going further, run the conflicts step per `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` → Conflicts clearance.

- **Status:** `cleared | pending | not-run | waived`
- **Method:** match what `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` declares (`corporate-legal | outside-counsel | system-check | informal | other`). If the declared method is `informal`, say so — the record still captures that a counsel's-judgment check was the basis.
...
- Severity: high | medium | low (reference the `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` severity bands)
- Likelihood: high | medium | low (reference the `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` likelihood bands)
...
If the risk calibration in `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` is thin, don't fake precision. Use the user's gut and note the thinness.

### 5. Materiality

Against the house thresholds in `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md`:
...
From `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` landscape — which internal stakeholders are involved?
- Business lead
...
### `~/.codex/claude-for-legal/litigation-legal/matters/[slug]/matter.md`
...
### `~/.codex/claude-for-legal/litigation-legal/matters/[slug]/history.md`
...
### Append to `~/.codex/claude-for-legal/litigation-legal/matters/_log.yaml`
