...
description: >
  Codex CLI version of employment-legal:handbook-updates. Diff a proposed handbook change against the current version, flag ripple effects and state supplement impacts. Use when user says "update the handbook", "add this to the handbook", "handbook change", or has a policy ready for insertion.
---

# Codex Adaptation Notes

This skill was converted from `employment-legal:handbook-updates` in the Claude for Legal repository. In Codex CLI, invoke it by asking for the workflow by name, for example `employment-legal-handbook-updates`, or by describing the legal task in natural language.
...
`~/.codex/claude-for-legal/employment-legal/CLAUDE.md` → handbook location, state supplements list, update cadence.
...
For each state supplement in `~/.codex/claude-for-legal/employment-legal/CLAUDE.md`:
