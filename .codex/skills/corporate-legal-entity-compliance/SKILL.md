...
# Codex skill: corporate-legal-entity-compliance

1. Load `~/.codex/claude-for-legal/corporate-legal/CLAUDE.md` → `## Entity Management` (entity table, jurisdictions, registered agent).
...
3. Read/write `~/.codex/claude-for-legal/corporate-legal/entities/compliance-tracker.yaml`.
...
Lives at `~/.codex/claude-for-legal/corporate-legal/entities/compliance-tracker.yaml`. Structure:
...
Read `~/.codex/claude-for-legal/corporate-legal/CLAUDE.md` → `## Entity Management` → Entity table. If the entity table
...
Generate `~/.codex/claude-for-legal/corporate-legal/entities/compliance-tracker.yaml` with all entities and their
...
**Before directing or confirming a filing:** Read `## Who's using this` in `~/.codex/claude-for-legal/corporate-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
...
- Based on `~/.codex/claude-for-legal/corporate-legal/CLAUDE.md` entity table: are there states in the company's
...
- From `~/.codex/claude-for-legal/corporate-legal/CLAUDE.md`: if intercompany agreements are marked as partial or no,
...
POTENTIAL GAPS
  Foreign qualification: [flag question — confirm operational presence in:]
    [list of states from `~/.codex/claude-for-legal/corporate-legal/CLAUDE.md` footprint not in tracker as qualified]
  Intercompany agreements: [status from `~/.codex/claude-for-legal/corporate-legal/CLAUDE.md`]
