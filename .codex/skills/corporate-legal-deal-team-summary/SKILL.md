...
description: >
  Codex CLI version of corporate-legal:deal-team-summary. Aggregate diligence findings into a deal team briefing at the right altitude for the audience — exec summary for leadership, working summary for the team. Use when user says "brief the deal team", "what's the state of diligence", "summarize findings for [audience]", "deal update", or on the briefing cadence.
---

# Codex Adaptation Notes

This skill was converted from `corporate-legal:deal-team-summary` in the Claude for Legal repository. In Codex CLI, invoke it by asking for the workflow by name, for example `corporate-legal-deal-team-summary`, or by describing the legal task in natural language.
...
- `~/.codex/claude-for-legal/corporate-legal/CLAUDE.md` → Deal team briefing (cadence, format, what the business reads)
- `~/.codex/claude-for-legal/corporate-legal/deals/[code]/deal-context.md` → deal lead, timeline
- Current findings from diligence-issue-extraction output

## Audience tiers

Per `~/.codex/claude-for-legal/corporate-legal/CLAUDE.md` — what the business reads vs. what's for the file. Default tiers:
...
If this is a recurring brief (per `~/.codex/claude-for-legal/corporate-legal/CLAUDE.md` cadence), lead with what changed:
