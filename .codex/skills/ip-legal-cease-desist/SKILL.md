...
description: >
  Codex CLI version of ip-legal:cease-desist. Draft a cease-and-desist letter (send mode) or triage one you received (receive mode). Use when asserting your rights against an infringer with a demand letter calibrated to your enforcement posture, or when an incoming C&D needs triage into a structured options memo with a recommendation.
argument-hint: "<--send | --receive> [context, counterparty, or path to incoming letter]"
---

# Codex Adaptation Notes

This skill was converted from `ip-legal:cease-desist` in the Claude for Legal repository. In Codex CLI, invoke it by asking for the workflow by name, for example `ip-legal-cease-desist`, or by describing the legal task in natural language.
...
# Codex skill: ip-legal-cease-desist
