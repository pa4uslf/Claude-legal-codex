...
# Codex skill: privacy-legal-use-case-triage

1. Read `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md`. Confirm privacy practice is configured — if not, stop and direct to setup.
...
Before triaging, always read `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md`. The PIA trigger criteria, regulatory
...
Read `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md` → `## PIA house style` → Trigger criteria. Apply them.
...
Read `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md` → `## Privacy policy commitments`. Check the proposed activity
