...
# Codex skill: employment-legal-wage-hour-qa

1. Load `~/.codex/claude-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint.
...
`~/.codex/claude-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint. If the question doesn't specify a
