...
# Codex skill: ai-governance-legal-use-case-triage

1. Read `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md`. Confirm registry is populated — if not, stop and direct to setup.
...
## Read `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md` first

Before triaging, always read `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md`. The use case registry and red lines there
...
Check the use case registry in `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md` for a direct or close match.
...
The APPROVED / CONDITIONAL / NOT APPROVED buckets, the red-line definitions, and the CONDITIONAL required-controls list all come from `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md` → `## AI use case triage criteria` and `## Use case registry`. If the playbook doesn't define a criterion the use case turns on, ask the user: "Your playbook doesn't cover [specific question]. What's your default position? I'll add it to `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md` so the next triage is consistent."

**Before issuing an APPROVED classification (approving an AI use case for deployment):** Read `## Who's using this` in `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
**Governance tier:** [Standard / Elevated / High — per `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md`]
...
> "Add to `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md` → Use case registry. This means next time the same request
