...
description: >
  Codex CLI version of litigation-legal:matter-briefing. Deep briefing on one matter — current posture, what's changed, next deadline, open questions, and a risk re-assessment check, ready before a GC update or outside counsel call. Use when the user says "brief me on [matter]", "where are we on [matter]", or needs a read on a specific matter.
argument-hint: "[slug]"
---

# Codex Adaptation Notes

This skill was converted from `litigation-legal:matter-briefing` in the Claude for Legal repository. In Codex CLI, invoke it by asking for the workflow by name, for example `litigation-legal-matter-briefing`, or by describing the legal task in natural language.
...
# Codex skill: litigation-legal-matter-briefing

1. Load `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` → risk calibration + relevant stakeholders.
2. Follow the workflow and reference below.
3. Read `~/.codex/claude-for-legal/litigation-legal/matters/[slug]/matter.md` + `~/.codex/claude-for-legal/litigation-legal/matters/[slug]/history.md` + log row from `_log.yaml`.
...
- `~/.codex/claude-for-legal/litigation-legal/matters/_log.yaml` — structured row
- `~/.codex/claude-for-legal/litigation-legal/matters/[slug]/matter.md` — narrative intake
- `~/.codex/claude-for-legal/litigation-legal/matters/[slug]/history.md` — event log
- `~/.codex/claude-for-legal/litigation-legal/CLAUDE.md` — risk calibration (so "risk: high" means something specific, not generic)
