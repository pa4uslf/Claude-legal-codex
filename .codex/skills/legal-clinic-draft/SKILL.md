...
# Codex skill: legal-clinic-draft

1. Load `~/.codex/claude-for-legal/legal-clinic/CLAUDE.md` → practice-area templates, jurisdiction, local rules, supervision style.
...
`~/.codex/claude-for-legal/legal-clinic/CLAUDE.md` → practice areas, practice-area templates, jurisdiction (state + local court + any local rules ingested), supervision style.
...
Match the request to the clinic's template set (from `~/.codex/claude-for-legal/legal-clinic/CLAUDE.md`). Common set by practice area:
...
Per `~/.codex/claude-for-legal/legal-clinic/CLAUDE.md` jurisdiction:
