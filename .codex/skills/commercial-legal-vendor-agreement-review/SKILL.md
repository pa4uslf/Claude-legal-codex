...
description: >
  Codex CLI version of commercial-legal:vendor-agreement-review. Reference: review of an inbound vendor agreement against the team playbook in `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md`. Flags deviations, assesses risk, generates specific redline language, and routes to the right approver. Loaded by commercial-legal-review when a vendor MSA, services agreement, or similar is detected.
---

# Codex Adaptation Notes

This skill was converted from `commercial-legal:vendor-agreement-review` in the Claude for Legal repository. In Codex CLI, invoke it by asking for the workflow by name, for example `commercial-legal-vendor-agreement-review`, or by describing the legal task in natural language.
...
Read a vendor agreement against the playbook this team actually uses (in `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md`), find every term that deviates, and tell the lawyer what to do about each one — with specific redline language, not vague "consider revising."
...
**Before reading the contract, read `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md`.** If it's missing or still has placeholders, surface this bounce:
...
The playbook in `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md` is the source of truth. It tells you:
...
Check the "one thing" from `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md` first. If present:
...
For each playbook category in `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md`, find the corresponding contract section and compare.
...
**Playbook says:** [our standard position, quoted from `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md`]
...
**If they won't move:** [the fallback from `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md`, or "escalate to [person]"
...
| Level | Means |
|---|---|
| 🔴 Critical | Don't sign without fixing. A term on the team's "never accept" list in `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md`, or a deal-breaker. |
...
Severity is always applied *against `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md`*. If a term doesn't map cleanly to a playbook position, ask the user which bucket it belongs in and offer to record the answer in `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md`.
...
Check the escalation matrix in `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md` against:
...
**Before proceeding to send redlines to the counterparty:** Read `## Who's using this` in `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
**Before generating a signature envelope or routing for countersignature:** Read `## Who's using this` in `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
**Full memo (default):** As above. Goes in the [CLM] record or the Drive folder from `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md` house-style section.
...
- [ ] `~/.codex/claude-for-legal/commercial-legal/CLAUDE.md` was loaded and quoted — not generic market positions
