...
description: >
  Codex CLI version of legal-builder-hub:related-skills-surfacer. Suggest community skills based on recent activity in other plugins. Checks whether the community has built something relevant to a task and mentions it once, non-intrusively. Use when the user says "is there a community skill for this", "what else is out there", or asks for skill recommendations; also runs passively as part of other plugins' workflows.
---

# Codex Adaptation Notes

This skill was converted from `legal-builder-hub:related-skills-surfacer` in the Claude for Legal repository. In Codex CLI, invoke it by asking for the workflow by name, for example `legal-builder-hub-related-skills-surfacer`, or by describing the legal task in natural language.
...
# Codex skill: legal-builder-hub-related-skills-surfacer

1. Load `~/.codex/claude-for-legal/legal-builder-hub/CLAUDE.md` → practice profile.
...
`~/.codex/claude-for-legal/legal-builder-hub/CLAUDE.md` → practice profile, installed skills (don't suggest what's already installed).
...
Per `~/.codex/claude-for-legal/legal-builder-hub/CLAUDE.md` → new skill notifications:
