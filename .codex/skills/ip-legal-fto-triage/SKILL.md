...
# Codex skill: ip-legal-fto-triage
...
Before running triage, read `~/.codex/claude-for-legal/ip-legal/CLAUDE.md`. Pull:
...
Prepend the work-product header from `~/.codex/claude-for-legal/ip-legal/CLAUDE.md` `## Outputs`. Mark the document as privileged if the role is lawyer; see the non-lawyer gate below if not.
...
`~/.codex/claude-for-legal/ip-legal/matters/<matter-slug>/outputs/fto-triage-<subject-slug>-YYYY-MM-DD.md`.
Otherwise write to
`~/.codex/claude-for-legal/ip-legal/outputs/fto-triage-<subject-slug>-YYYY-MM-DD.md`
