...
# Codex skill: employment-legal-worker-classification
...
Read `~/.codex/claude-for-legal/employment-legal/CLAUDE.md` → jurisdictional footprint, any classification history or
...
If `~/.codex/claude-for-legal/employment-legal/CLAUDE.md` records the company's house classification policy, apply it
...
Escalate per `~/.codex/claude-for-legal/employment-legal/CLAUDE.md` if any of the following, or any team-specific
...
**Before producing a "Proceed as IC / employee / agency / vendor" final recommendation:** Read `## Who's using this` in `~/.codex/claude-for-legal/employment-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
