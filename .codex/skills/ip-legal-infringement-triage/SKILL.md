...
# Codex skill: ip-legal-infringement-triage
...
Read `~/.codex/claude-for-legal/ip-legal/CLAUDE.md`. Pull:
...
`~/.codex/claude-for-legal/ip-legal/matters/<matter-slug>/outputs/infringe-<mode>-<subject-slug>-YYYY-MM-DD.md`.
Otherwise write to
`~/.codex/claude-for-legal/ip-legal/outputs/infringe-<mode>-<subject-slug>-YYYY-MM-DD.md`
