...
# Codex skill: privacy-legal-dsar-response

1. Load `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md` → DSAR process (systems list, verification method, SLA).
...
Read `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md` → `## DSAR process`. That section has:
...
Per the method in `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md`. Common approaches:
...
Walk the systems list from `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md`. For each system:
...
**Before proceeding to send either letter to the data subject:** Read `## Who's using this` in `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
Per `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md` → Escalation table, escalate when:
...
If `~/.codex/claude-for-legal/privacy-legal/CLAUDE.md` → `## DSAR process` records an internal SLA that is tighter than the legal deadline, use the internal SLA and note the legal backstop.
