...
# Codex skill: legal-clinic-deadlines

1. Load `~/.codex/claude-for-legal/legal-clinic/CLAUDE.md` → jurisdiction, practice areas, warning-day cadence.
2. Use the workflow below.
3. Route by flag:
   - `--add`: capture case, type, description, due date, source, owner. Write to `~/.codex/claude-for-legal/legal-clinic/deadlines.yaml`. Check for duplicates first.
...
- `~/.codex/claude-for-legal/legal-clinic/CLAUDE.md` → jurisdiction, practice areas, deadline warning days (default 14/7/3/1), supervising attorneys
- `~/.codex/claude-for-legal/legal-clinic/deadlines.yaml` — the ledger
...
Read `~/.codex/claude-for-legal/legal-clinic/deadlines.yaml`. Produce:
...
Per `~/.codex/claude-for-legal/legal-clinic/CLAUDE.md` deadline warning days. Default 14, 7, 3, 1.
...
- **`/status`:** the status skill reads `~/.codex/claude-for-legal/legal-clinic/deadlines.yaml` for the relevant case and includes upcoming deadlines in its output.
