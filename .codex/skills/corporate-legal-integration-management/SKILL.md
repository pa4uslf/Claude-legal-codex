...
description: >
  Codex CLI version of corporate-legal:integration-management. Post-closing M&A integration tracker — phased workplan, consent tracking, contract assignment at scale, weekly status reports. Initializes from whatever deal artifacts are available (purchase agreement, deal summary, closing checklist) and connects to deal-context.md and closing-checklist.yaml from the M&A cold-start. Use when user says "integration", "post-close", "post-closing", "consents outstanding", "contract assignment", "integration status", or "what's left on the deal".
argument-hint: "[--init | --contracts | --report | --update | --export [--format csv|table] [--section all|consents|contracts|workplan]] [--deal [code]]"
---

# Codex Adaptation Notes

This skill was converted from `corporate-legal:integration-management` in the Claude for Legal repository. In Codex CLI, invoke it by asking for the workflow by name, for example `corporate-legal-integration-management`, or by describing the legal task in natural language.
...
# Codex skill: corporate-legal-integration-management
...
5. Read/write `~/.codex/claude-for-legal/corporate-legal/deals/[code]/integration-tracker.yaml`.
...
Lives at `~/.codex/claude-for-legal/corporate-legal/deals/[code]/integration-tracker.yaml`. Read `deal-context.md` for
...
Read `~/.codex/claude-for-legal/corporate-legal/deals/[code]/deal-context.md`. If not found: ask for deal code name,
target company, close date, deal lead, and outside counsel. Write to
deal-context.md if it doesn't exist.

Read `~/.codex/claude-for-legal/corporate-legal/deals/[code]/closing-checklist.yaml` if it exists. Any items marked as
...
>   automatically from `~/.codex/claude-for-legal/corporate-legal/deals/[code]/closing-checklist.yaml`
