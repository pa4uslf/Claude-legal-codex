...
# Codex skill: corporate-legal-closing-checklist

1. Read `~/.codex/claude-for-legal/corporate-legal/deals/[code]/closing-checklist.yaml` and use the modes below.
...
Lives at `~/.codex/claude-for-legal/corporate-legal/deals/[code]/closing-checklist.yaml`. Structure:
...
**Before producing a "ready to close / all CPs satisfied" certification or closing memo:** Read `## Who's using this` in `~/.codex/claude-for-legal/corporate-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
