...
# Codex skill: ai-governance-legal-policy-monitor

**Sweep mode** (no argument or `--sweep`):
1. Read `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md` → outputs folder path, AI policy document, last sweep date.
...
6. Flag any use cases in outputs not yet added to the `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md` registry.
7. Present results to the human. Only after acknowledgment, update `Last policy sweep` and `gaps_found` in `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md`.

**Direct query mode** (with description argument):
1. Read `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md` → current policy commitments, use case registry, actual policy document.
...
→ **AI policy document**. The commitments in `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md` are a summary; the actual
...
**Do not update `Last policy sweep` or `gaps_found` automatically.** After the sweep results are presented, wait for the human to acknowledge them ("sweep acknowledged," "results reviewed," or equivalent). Only then update `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md`:
...
- Extract: vendor added, data use terms agreed to, any AI-specific provisions
  accepted that differ from standard positions in `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md`
...
[Any use cases approved since the last sweep that aren't yet in the `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md`
...
[If this use case isn't in the registry: "Add to `~/.codex/claude-for-legal/ai-governance-legal/CLAUDE.md` → Use case registry:"]
```
